...
import { DEFAULT_SESSION_BANNER_URL, BACKEND_HOST_URL } from '@/shared/constants'
import { get12HourTimeFromDateObject, getDateFromDateObject } from '@/shared/utils/format'
  ...
  return (
    <div className='flex justify-between items-center w-full p-4'>
      <div className='flex justify-start items-center gap-4'>
        <Image
          src={session.bannerImageUrl?.trim() ? BACKEND_HOST_URL + session.bannerImageUrl.trim() : DEFAULT_SESSION_BANNER_URL}
        ...
        <div className='flex flex-col items-center justify-start gap-1'>
          ...
          <p className='text-black text-xs font-medium'>
            {get12HourTimeFromDateObject(new Date(session.startDate))}
          </p>
        </div>
